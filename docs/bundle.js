...
eval("const { loadTemplates, loadActions } = __webpack_require__(/*! ../router */ \"./src/router.js\");\nconst { APP_ID } = __webpack_require__(/*! ../configs/pages-id.yml */ \"./src/configs/pages-id.yml\");\nconst $ = document.querySelector.bind(document);\n\nglobalThis.addEventListener(\"load\", () => {\n    loadTemplates();\n    loadActions();\n    $(`#${APP_ID} .page-landing`).style.setProperty(\"display\", \"block\");\n});\n\n\n//# sourceURL=webpack://stag-dotjs/./src/actions/index.js?");
...
/*! export loadTemplates [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
